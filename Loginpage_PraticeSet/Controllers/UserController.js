...
exports.signup=async (req,res)=>{
    const body=req.body;
    if(!body || !body.user_name || !body.password || !body.role_name){
...
exports.signin = async(req,res)=>{
    ...
    if(!body || !body.user_name || !body.password){
        ...
        if(matchedPassword){
            ...
            console.log(user);
            if(user.role_name == 'admin'){         //make change here adding (/) in admin .
                return res.render('/admin');            //make change here delete (/) in admin .
            }else{
